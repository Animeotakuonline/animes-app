const cardsData = [
  {
    "imageSrc": "../../../src/paginas/img/2024/kimetsu-no-yaiba-hashira-geiko-hen.jpg",
    "dateAdded": "2024",
    ...
    "readMoreLink": "../todos-los-animes/2024/informacion/Kimetsu-no-Yaiba-Hashira-Geiko-Hen.html",
...
function filtrarPorGenero(genero) {
  return cardsData.filter(card => card.generos.includes(genero));
}

// Filtrar por el género "accion"
const generoAccion = filtrarPorGenero('accion');
console.log("Tarjetas de género acción:", generoAccion);

// Filtrar por el género "fantasia"
const generoFantasia = filtrarPorGenero('fantasia');
console.log("Tarjetas de género fantasía:", generoFantasia);

// Define la función para filtrar por género (debe estar definida en tu archivo JavaScript)
function filtrarPorGenero(genero) {
  return cardsData.filter(card => card.generos.includes(genero));
}