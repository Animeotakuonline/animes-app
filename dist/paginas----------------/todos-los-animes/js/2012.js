...
const cardsData = [
    {
      imageSrc: "galeria de archivos-1/hikikomari-kyuuketsuki-no-monmon-1695739927.jpg",
      dateAdded: "2023",
  ...
  function addCard(cardData, index) {
    ...
    const isSpecialCard = [0, 2, 4, 7].includes(index);
      ...
      <div class="p-4 sm:w-1/2 lg:w-1/4 ${isSpecialCard ? 'bg-gradient-to-r from-yellow-500 to-red-500 text-white' : 'bg-white text-black'} mx-auto">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div class="p-6">
            ...
            <h3 class="text-black hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">${cardData.status}</h3>
